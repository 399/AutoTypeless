...
EXECUTABLE="${EXECUTABLE_PATH:-$PROJECT_DIR/.build/${BUILD_ARCH}-apple-macosx/release/AutoTypelessMenuBar}"
if [[ ! -f "$EXECUTABLE" && -f "$PROJECT_DIR/.build/release/AutoTypelessMenuBar" ]]; then
